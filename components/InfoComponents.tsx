  ...
  return (
    <div className="w-full flex flex-col gap-3 lg:gap-0">
      ...
      <TypingAnimation
        ...
        duration={10}
      >
        Hello, my name is Huỳnh Tấn Phát, and I am currently working as a
        Front-end Developer. With over 2 years of experience in user interface
